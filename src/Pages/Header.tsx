                    ...
                    <div className="max-w-xl">
                        ...
                        <div>
                            <p className=' text-gray-400'>
                                Frontend development is the art of turning{' '}
                                ...
                                and creating user interfaces that feel like{' '}
                        ...
                        <ul className="flex justif mt-6 space-x-5">
                            <li>
                                <a href="https://www.facebook.com/share/3KXKNDjAT5svEQKC/" className="text-gray-500 hover:text-gray-900 ">
                            ...
                            <li>
                                <a href="https://www.linkedin.com/in/muhammad-abbas-dev/" className="text-gray-500 hover:text-gray-900 ">
                                    {/* <svg className="w-10 h-10" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                        <path fill-rule="evenodd"
                                    ...
                                    <svg className="h-10 w-10 p-1 text-" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <li>
                                <a href="https://twitter.com/?lang=en" className="text-gray-500 hover:text-gray-900 ">
                                    <svg className="w-10 h-10" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                        <path
                            ...
                            <li>
                                <a href="https://github.com/abbaskhan349" className="text-gray-500 hover:text-gray-900 ">
                                    <svg className="w-10 h-10" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                        <path fill-rule="evenodd"
